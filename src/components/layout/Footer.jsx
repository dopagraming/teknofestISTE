      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm text-light-400 mb-4">
              A student-led initiative dedicated to participating in Teknofest
              competitions and fostering innovation in technology.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a
                  href="mailto:info@teknofestclub.com"
                  className="text-light-400 hover:text-primary-400 transition-colors"
                >
        ...
        <div className="border-t border-dark-600 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-light-500 mb-4 md:mb-0">
            &copy; {currentYear} Teknofest Clone. {t("common.moreInfo")}
          </p>
